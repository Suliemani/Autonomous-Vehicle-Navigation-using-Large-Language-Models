...
class GlobalRoutePlanner(object):
    ...
    def _build_topology(self):
        ...
        - path (list of carla.Waypoint): list of waypoints between entry to exit, separated by the
          resolution
        """
        self._topology = []
    ...
    def _build_graph(self):
        """
        This function builds a networkx graph representation of topology, creating several class
        attributes:
    ...
    def _find_loose_ends(self):
        ...
        for segment in self._topology:
            ...
            if (
                ...
                path = []
                while (
                    next_wp is not None and next_wp
